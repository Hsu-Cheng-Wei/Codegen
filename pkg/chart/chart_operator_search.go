...
func (chart *Operator) add(rel *release.Release) {
	chart.index++
...
func (chart *Operator) GetName(index int) (string, error) {
...
func (chart *Operator) GetRelease() error {
...
func (chart *Operator) GetAndPrintRelease() error {
